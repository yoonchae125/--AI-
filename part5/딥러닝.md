...
![image-20191227144523574](image/image-20191227144523574.png)
...
![image-20191227145430835](image/image-20191227145430835.png)
...
2. Weight regularization
   ...
   - 값이 커지는 θ에 대한 함수를 기존의 Cost function에 더해 Trade-off관계 속에서 최적값을 찾을 수 있음
     ...
     ![image-20191227160703758](image/image-20191227160703758.png)
...
3. Advanced gradient descent algorithms
   ...
   >
   > ![image-20191227164603155](image/image-20191227164603155.png)
   >
   ...
   >
   > ![image-20191227164711860](image/image-20191227164711860.png)
   >
...
1. Droupout
   ...
   ![image-20191227171025815](image/image-20191227171025815.png)
